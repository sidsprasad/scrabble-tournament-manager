module.exports = function(app, db) {
	...
	// Get Participants
	app.get('/leagues/:leagueId/getParticipants', function (req, res) {
	...
	// Create a new league
	app.post('/leagues/createLeague', function (req, res) {
	...
	app.post('/leagues/:leagueId/addPlayer', function (req, res) {
	...
	app.post('/leagues/:leagueId/start', function (req, res) {
